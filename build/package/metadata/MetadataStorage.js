...
var MetadataStorage = /** @class */ (function () {
     ...
     */
    MetadataStorage.prototype.getTargetValidationMetadatas = function (targetConstructor, targetSchema, alwaysDefault, strictGroups, groups) {
        var alwaysIncludeMetadata = function (metadata) {
            if (typeof metadata.always !== "undefined") {
                return metadata.always;
            }
            return metadata.groups && metadata.groups.length ? false : alwaysDefault;
        };
        var ignoreMetadataBecauseOfStrictGroups = function (metadata) {
            return strictGroups && (!groups || !groups.length) && !!metadata.groups;
        };
