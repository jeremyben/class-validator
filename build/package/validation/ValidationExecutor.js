...
var ValidationExecutor = /** @class */ (function () {
    ...
    ValidationExecutor.prototype.execute = function (object, targetSchema, validationErrors) {
        ...
        var alwaysDefault = this.validatorOptions && this.validatorOptions.alwaysDefault || false;
        var targetMetadatas = this.metadataStorage.getTargetValidationMetadatas(object.constructor, targetSchema, alwaysDefault, strictGroups, groups);
        ...
        Object.keys(groupedMetadatas).forEach(function (propertyName) {
            ...
            if ((value === undefined) && _this.validatorOptions && _this.validatorOptions.skipMissingProperties === true) {
                return;
            }
